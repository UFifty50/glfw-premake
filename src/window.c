...
void glfwDefaultWindowHints(void) {
    ...
    _glfw.hints.window.hasTitlebar = GLFW_TRUE;
...
GLFWAPI void glfwWindowHint(int hint, int value) {
    ...
    switch (hint) {
        ...
        case GLFW_DECORATED:
            ...
            return;
        case GLFW_HAS_TITLEBAR:
            _glfw.hints.window.hasTitlebar = value ? GLFW_TRUE : GLFW_FALSE;
            return;
        case GLFW_FOCUSED:
...
GLFWAPI void glfwSetWindowSizeLimits(GLFWwindow* handle, int minwidth, int minheight,
...
GLFWAPI int glfwGetWindowAttrib(GLFWwindow* handle, int attrib) {
    ...
    switch (attrib) {
        ...
        case GLFW_HAS_TITLEBAR:
            return _glfw.hints.window.hasTitlebar;
        case GLFW_FLOATING:
...
GLFWAPI void glfwSetWindowAttrib(GLFWwindow* handle, int attrib, int value) {
    ...
    switch (attrib) {
        ...
        case GLFW_HAS_TITLEBAR:
            if (_glfw.hints.window.hasTitlebar == value) return;

            _glfw.hints.window.hasTitlebar = value;
            if (!window->monitor) _glfw.platform.setWindowTitleBar(window, value);
            return;
        case GLFW_FLOATING:
...
GLFWAPI void glfwSetWindowMonitor(GLFWwindow* wh, GLFWmonitor* mh, int xpos, int ypos,
...
GLFWAPI GLFWtitlebarhittestfun
glfwSetTitlebarHitTestCallback(GLFWwindow* handle, GLFWtitlebarhittestfun tbhtfun) {
    _GLFWwindow* window = (_GLFWwindow*)handle;
    assert(window != NULL);
