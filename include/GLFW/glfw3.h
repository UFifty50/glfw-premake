 ...
 *
 *  NOTE: Custom addition, not part of the official GLFW API.
 */
#define GLFW_HAS_TITLEBAR 0x00C2000D
 ...
 *  A window titlebar hittest callback has the following signature:
 *  @code
 *  void fn_callback_name(GLFWwindow* window, int xpos, int ypos, int hit)
 *  @endcode
 *
 *  @param[in] window The window that was moved.
 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowSizeLimits(GLFWwindow* window, int minwidth, int minheight,
 ...
 *  @ingroup window
 */
GLFWAPI void glfwSetWindowMonitor(GLFWwindow* window, GLFWmonitor* monitor, int xpos,
...
glfwSetTitlebarHitTestCallback(GLFWwindow* window, GLFWtitlebarhittestfun callback);
